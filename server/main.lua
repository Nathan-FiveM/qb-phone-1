...
local WebHook = "https://discord.com/api/webhooks/916865517233524757/Fn7PXwhV0ENpt1mVoBcYdvPY2GT4FwCl5pWg6OLnkSSwEocakO0nWMCZ6s5i1aG6OQ4V"
...
QBCore.Functions.CreateCallback('qb-phone:server:GetVehicleSearchResults', function(source, cb, search)
    ...
    elseif result[1].vinnum == "scratched" then
        if GeneratedPlates ~= nil and GeneratedPlates[plate] ~= nil then
    ...
    for k, v in pairs(QBCore.Functions.GetPlayers()) do
        ...
        if Player ~= nil then
            if (Player.PlayerData.job.name == "lawyer" or Player.PlayerData.job.name == "realestate" or
                ...
                Player.PlayerData.job.name == "ghostbusters" or Player.PlayerData.job.name == "ambulance" or
                Player.PlayerData.job.name == "harmony" or Player.PlayerData.job.name == "tuner" or
                Player.PlayerData.job.name == "hayes" or Player.PlayerData.job.name == "jdm" or
                Player.PlayerData.job.name == "driftkings") and
...
QBCore.Commands.Add('bill', 'Bill A Player', {{name = 'id', help = 'Player ID'}, {name = 'amount', help = 'Fine Amount'}}, false, function(source, args)
    ...
    if biller.PlayerData.job.name == "police" or biller.PlayerData.job.name == "bcso" or biller.PlayerData.job.name == "sast" or biller.PlayerData.job.name == 'ambulance' or biller.PlayerData.job.name == 'mechanic' or biller.PlayerData.job.name == 'driftkings' or biller.PlayerData.job.name == 'hayes' or biller.PlayerData.job.name == 'tuner' or biller.PlayerData.job.name == 'jdm' or biller.PlayerData.job.name == 'harmony' or biller.PlayerData.job.name == 'lawyer' or biller.PlayerData.job.name == 'ghostbusters' then
        if billed ~= nil then
